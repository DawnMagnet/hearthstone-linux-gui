...
use install_plan::{checked_install_path, installed_target_path, InstallItem};
use installfile::InstallFile;
use local_manifest::{
    cleanup_stale_installed_files, scan_local_install, InstalledFileRecord, InstalledManifest,
};
use std::{
    path::{Path, PathBuf},
